...
export type FullRecipeResponse<Texpand = unknown> = Required<FullRecipeRecord> &
  BaseSystemFields<Texpand>
export type InventoryResponse<Texpand = unknown> = Required<InventoryRecord> &
  BaseSystemFields<Texpand>
export type ItemRecipesResponse<Texpand = unknown> = Required<ItemRecipesRecord> &
  BaseSystemFields<Texpand>
export type ItemsResponse<Texpand = unknown> = Required<ItemsRecord> & BaseSystemFields<Texpand>
export type MiddleItemRecipesResponse<Texpand = unknown> = Required<MiddleItemRecipesRecord> &
  BaseSystemFields<Texpand>
export type MiddleItemsResponse<Texpand = unknown> = Required<MiddleItemsRecord> &
  BaseSystemFields<Texpand>
